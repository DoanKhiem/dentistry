...
{{--                <div class="col-ml-12">--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="needs-validation" novalidate="" action="{{route('patient.update', $item->id)}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <h4 class="header-title">Thông tin bệnh nhân</h4>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Mã bệnh nhân</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-email-input" class="col-form-label">Số điện thoại</label>
