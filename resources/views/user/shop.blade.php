                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        <div class="sidebar">
                                ...
                                <div class="side-product-active owl-carousel">
                                    ...
                                    <div class="side-pro-item">
                                        ...
                                        <div class="single-product single-product-sidebar">
                                            ...
                                            <div class="pro-img">
                                                <a href="product.html">
                                                    ...
                                                    <img class="secondary-img" src="{{ url('user') }}\img\products\19.jpg" alt="single-product">
                                                </a>
                                        ...
                                        <div class="single-product single-product-sidebar">
                                            ...
                                            <div class="pro-img">
                                                <a href="product.html">
                                                    <img class="primary-img" src="{{ url('user') }}\img\products\2.jpg" alt="single-product">
                                                    <img class="secondary-img" src="{{ url('user') }}\img\products\1.jpg" alt="single-product">
                                                </a>
                                            </div>
                                            <!-- Product Image End -->
                                            <!-- Product Content Start -->
                                        ...
                                        <div class="single-product single-product-sidebar">
                                            ...
                                            <div class="pro-img">
                                                <a href="product.html">
                                                    <img class="primary-img" src="{{ url('user') }}\img\products\25.jpg" alt="single-product">
                                                    <img class="secondary-img" src="{{ url('user') }}\img\products\26.jpg" alt="single-product">
                                                </a>
                                            </div>
                                            <!-- Product Image End -->
                                            <!-- Product Content Start -->
                                    ...
                                    <div class="side-pro-item">
                                        ...
                                        <div class="single-product single-product-sidebar">
                                            ...
                                            <div class="pro-img">
                                                <a href="product.html">
                                                    <img class="primary-img" src="{{ url('user') }}\img\products\33.jpg" alt="single-product">
                                                    <img class="secondary-img" src="{{ url('user') }}\img\products\34.jpg" alt="single-product">
                                                </a>
                                            </div>
                                            <!-- Product Image End -->
                                            <!-- Product Content Start -->
                                        ...
                                        <div class="single-product single-product-sidebar">
                                            ...
                                            <div class="pro-img">
                                                <a href="product.html">
                                                    <img class="primary-img" src="{{ url('user') }}\img\products\31.jpg" alt="single-product">
                                                    <img class="secondary-img" src="{{ url('user') }}\img\products\32.jpg" alt="single-product">
                                                </a>
                                            </div>
                                            <!-- Product Image End -->
                                            <!-- Product Content Start -->
                            ...
                            <!-- Single Banner Start -->
                            <div class="col-img">
                                <a href="shop.html"><img src="{{ url('user') }}\img\banner\banner-sidebar.jpg" alt="slider-banner"></a>
                            </div>
                            <!-- Single Banner End -->
                        </div>
                    </div>
