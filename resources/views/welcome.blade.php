...
{{--                    </li>--}}
                    ...
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_5">Đặt lịch</a>
                    </li>
                </ul>
...
{{--                            <source src="{{asset('user/videos/pexels-mike-jones-9046237.mp4')}}" type="video/mp4">--}}
...
{{--                    <em class="text-white">Creative Baristas</em>--}}
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="team-block-wrap">
                        ...
                        <div class="team-block-image-wrap">
                            <img src="{{asset('user/images/team/portrait-elegant-old-man-wearing-suit.jpg')}}" class="team-block-image img-fluid" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="team-block-wrap">
                        ...
                        <div class="team-block-image-wrap">
                            <img src="{{asset('user/images/team/cute-korean-barista-girl-pouring-coffee-prepare-filter-batch-brew-pour-working-cafe.jpg')}}" class="team-block-image img-fluid" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="team-block-wrap">
                        ...
                        <div class="team-block-image-wrap">
                            <img src="{{asset('user/images/team/small-business-owner-drinking-coffee.jpg')}}" class="team-block-image img-fluid" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-block-wrap">
                        ...
                        <div class="team-block-image-wrap">
                            <img src="{{asset('user/images/team/smiley-business-woman-working-cashier.jpg')}}" class="team-block-image img-fluid" alt="">
                        </div>
                    </div>
                </div>
...
{{--                                    <img src="{{asset('user/images/reviews/young-woman-with-round-glasses-yellow-sweater.jpg')}}" class="reviews-block-image img-fluid" alt="">--}}
...
{{--                            <div class="reviews-block">--}}
{{--                                <div class="reviews-block-image-wrap d-flex align-items-center">--}}
{{--                                    <img src="{{asset('user/images/reviews/senior-man-white-sweater-eyeglasses.jpg')}}" class="reviews-block-image img-fluid" alt="">--}}
...
{{--                            <div class="reviews-block">--}}
{{--                                <div class="reviews-block-image-wrap d-flex align-items-center">--}}
{{--                                    <img src="{{asset('user/images/reviews/young-beautiful-woman-pink-warm-sweater-natural-look-smiling-portrait-isolated-long-hair.jpg')}}" class="reviews-block-image img-fluid" alt="">--}}
